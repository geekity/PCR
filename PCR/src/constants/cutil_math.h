...
#ifndef CUTIL_MATH_H_
#define CUTIL_MATH_H_
...
inline __host__ __device__ float2 make_float2(float2 a)
{
...
inline __host__ __device__ void operator+=(float2 &a, float3 b)
{
    a.x += b.x; a.y += b.y;
}
...
inline __host__ __device__ float3 operator*(float3 a, float2 b)
{
    return make_float3(a.x * b.x, a.y * b.y, 0.0);
}
